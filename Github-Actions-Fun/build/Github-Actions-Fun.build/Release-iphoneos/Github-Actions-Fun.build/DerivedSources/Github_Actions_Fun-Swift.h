...
#ifndef GITHUB_ACTIONS_FUN_SWIFT_H
#define GITHUB_ACTIONS_FUN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Github_Actions_Fun",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18Github_Actions_Fun11AppDelegate")
...
SWIFT_CLASS("_TtC18Github_Actions_Fun13SceneDelegate")
